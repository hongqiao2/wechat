    ...
    <div class="personal-name">
      <div class="content-wrapper" ref="wrapper">
        <div class="content-text">
          <yd-navbar  @click="back" slot="navbar" title="设置签名">
              <router-link to="/me/personal" slot="left">
                  <yd-navbar-back-icon></yd-navbar-back-icon>
              </router-link>
              <router-link to="#" slot="right">完成</router-link>
          </yd-navbar>
          <yd-cell-group>
              <yd-cell-item>
                  <yd-textarea slot="right" placeholder="请输入签名！" maxlength="40"></yd-textarea>
              </yd-cell-item>
          </yd-cell-group>
        </div>
      </div>
...
<template>
  <div class="personal-name">
    <div class="content-wrapper" ref="wrapper">
      <div class="content-text">
        <yd-navbar @click.native="back" slot="navbar" title="设置签名">
          <router-link to slot="left">
            <yd-navbar-back-icon></yd-navbar-back-icon>
          </router-link>
          <router-link to="/" @click.native="updateAutograph" slot="right">完成</router-link>
        </yd-navbar>
        <yd-cell-group>
          <yd-cell-item>
            <yd-textarea slot="right" v-model="autograph" placeholder="请输入签名！" maxlength="40"></yd-textarea>
          </yd-cell-item>
        </yd-cell-group>
      </div>
    </div>
